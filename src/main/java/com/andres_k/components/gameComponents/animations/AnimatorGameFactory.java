...
public class AnimatorGameFactory extends AnimatorFactory {
    ...
    public Animator getItemAnimator(EnumSprites index) throws SlickException, JSONException {
        ...
        if (index == EnumSprites.ASTEROID) {
            ...
            animator.addCollision(EnumAnimation.BASIC, StringTools.readFile(getClass().getClassLoader().getResource("json/asteroid.json")));
            ...
            animator.addCollision(EnumAnimation.BASIC, StringTools.readFile(getClass().getClassLoader().getResource("json/stone.json")));
            ...
            animator.addCollision(EnumAnimation.MOVE_LEFT, StringTools.readFile(getClass().getClassLoader().getResource("json/redShipLEFT.json")));
            animator.addCollision(EnumAnimation.MOVE_RIGHT, StringTools.readFile(getClass().getClassLoader().getResource("json/redShipRIGHT.json")));
            animator.addCollision(EnumAnimation.BASIC, StringTools.readFile(getClass().getClassLoader().getResource("json/redShipIDLE.json")));
            ...
            animator.addCollision(EnumAnimation.BASIC, StringTools.readFile(getClass().getClassLoader().getResource("json/barrier.json")));
        }
        return animator;
    }
