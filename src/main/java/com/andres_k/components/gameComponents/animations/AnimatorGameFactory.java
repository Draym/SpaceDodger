...
public class AnimatorGameFactory extends AnimatorFactory {
    ...
    public Animator getItemAnimator(EnumSprites index) throws SlickException, JSONException {
        ...
        if (index == EnumSprites.ASTEROID) {
            ...
            animator.addCollision(EnumAnimation.BASIC, StringTools.readInput(getClass().getClassLoader().getResourceAsStream("json/stone.json")));
            ...
            animator.addCollision(EnumAnimation.MOVE_LEFT, StringTools.readInput(getClass().getClassLoader().getResourceAsStream("json/redShipLEFT.json")));
            animator.addCollision(EnumAnimation.MOVE_RIGHT, StringTools.readInput(getClass().getClassLoader().getResourceAsStream("json/redShipRIGHT.json")));
            animator.addCollision(EnumAnimation.BASIC, StringTools.readInput(getClass().getClassLoader().getResourceAsStream("json/redShipIDLE.json")));
            ...
            animator.addCollision(EnumAnimation.BASIC, StringTools.readInput(getClass().getClassLoader().getResourceAsStream("json/barrier.json")));
        }
        return animator;
    }
